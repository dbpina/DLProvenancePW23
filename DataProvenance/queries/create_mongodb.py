...
def main(dbname, path):
	...
	if dbname in dblist:
	  print('The database exists.')
		...
		#debora_data = db['debora_data']
		debora_entities = db['debora_entities']
		...
		with open('D:/ipaw-23-experiments/Census/sample_entities.json') as f:
			file_data = json.load(f)
			debora_entities.insert_many(file_data)
			print('Imported debora data: ' + 'D:/ipaw-23-experiments/Census/sample_entities.json')	

...
data = pandas.read_csv("/scratch/rtm-uq/debora.pina/ipaw-23-experiments/Census/censusout.csv")

t_tuples = Task(1, dataflow_tag, exec_tag, "SplitDataset")
tinput_tuples = DataSet("iTuples", [Element(["/scratch/rtm-uq/debora.pina/ipaw-23-experiments/Census/censusout.csv","Census","Adult-Census"])])
...
with open("/scratch/rtm-uq/debora.pina/ipaw-23-experiments/Census/adult-records.txt") as file:
  lines = [line.rstrip('\n') for line in file]

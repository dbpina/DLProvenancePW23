...
def train_nn():
  ...
  classifier.add(Dense(x_train.shape[1], activation = 'relu', input_dim = x_train.shape[1]))
...
if __name__ == '__main__':
  data = pandas.read_csv("D:/giuliap/DataProvenance/prov_acquisition/fraud-balanced.csv")
